<script>
  import "./stylesForSideBar.css";
</script>

<div class="first w-17 md:w-[25%]">
  <div class="sidebar flex md:items-end flex-col sticky top-0">
    ...
    <ul class="flex flex-col text-2xl space-y-3 md:px-11 w-full">
      <li
      ...
      <li
        class="flex md:justify-start items-center gap-3 justify-center mr-4 md:w-fit hover:bg-gray-900 hover:cursor-pointer px-5 py-2 hover:rounded-full"
      >
        <span class="text-2xl material-symbols-outlined"> search </span><span
      ...
      <li
        class="flex md:justify-start items-center gap-3 justify-center mr-4 md:w-fit hover:bg-gray-900 hover:cursor-pointer px-5 py-2 hover:rounded-full"
      >
        <span class="text-2xl material-symbols-outlined"> message </span><span
          class="hidden md:block">Grade App</span
        >
      </li>
      <li
        class="flex md:justify-start items-center gap-3 justify-center mr-4 md:w-fit hover:bg-gray-900 hover:cursor-pointer px-5 py-2 hover:rounded-full"
      >
        <span class="text-2xl material-symbols-outlined"> lists </span><span
      ...
      <li
        class="flex md:justify-start items-center gap-3 justify-center mr-4 md:w-fit hover:bg-gray-900 hover:cursor-pointer px-5 py-2 hover:rounded-full"
      >
        <span class="text-2xl material-symbols-outlined"> bookmarks </span><span
      ...
      <li
        class="flex md:justify-start items-center gap-3 justify-center mr-4 md:w-fit hover:bg-gray-900 hover:cursor-pointer px-5 py-2 hover:rounded-full"
      >
        <span class="text-2xl material-symbols-outlined"> Group </span><span
      ...
      <li
        class="flex md:justify-start items-center gap-3 justify-center mr-4 md:w-fit hover:bg-gray-900 hover:cursor-pointer px-5 py-2 hover:rounded-full"
      >
        <span class="text-2xl material-symbols-outlined"> person </span><span
